"""
Django settings for misty_scene_40119 project.
...
ROOT_URLCONF = 'misty_scene_40119.urls'
...
WSGI_APPLICATION = 'misty_scene_40119.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_scene_40119 API",
    "DESCRIPTION": "API documentation for misty_scene_40119 App",
    "VERSION": "v1",
}
